...
ALLOWED_HOSTS = ['*', 'mindsetpi-v2-production.up.railway.app', 'https://mindsetpi-v2-production.up.railway.app','pi-trade.net', 'www.pi-trade.net']

# Add handler404 setting
HANDLER404 = 'app.views.mainnet'

CSRF_TRUSTED_ORIGINS = ['https://mindsetpi-v2-production.up.railway.app', 'https://pi-trade.net', 'https://www.pi-trade.net']
